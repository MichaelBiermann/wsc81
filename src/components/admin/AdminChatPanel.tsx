    ...
    return (
      <span key={key}>
        {parts.map((p, j) => {
          ...
          if (p === "ICON_BOOKABLE") return <span key={j} className="material-symbols-rounded" style={{ fontSize: 18, fontVariationSettings: "'FILL' 1" }} title="Buchbar">check_circle</span>;
          if (p === "ICON_NOT_BOOKABLE") return <span key={j} className="material-symbols-rounded" style={{ fontSize: 18, fontVariationSettings: "'FILL' 0" }} title="Nicht buchbar">cancel</span>;
