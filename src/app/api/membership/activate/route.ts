  ...
  const member = await prisma.$transaction(async (tx) => {
    const newMember = await tx.member.create({
      data: {
        ...
        person6Name: pending.person6Name,
        person6Dob: pending.person6Dob,
        person7Name: pending.person7Name,
        person7Dob: pending.person7Dob,
        person8Name: pending.person8Name,
        person8Dob: pending.person8Dob,
        person9Name: pending.person9Name,
        person9Dob: pending.person9Dob,
        person10Name: pending.person10Name,
        person10Dob: pending.person10Dob,
