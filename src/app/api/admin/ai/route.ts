...
Return ONLY the email body as HTML (use <p>, <ul>, <li>, <strong> — no <html>/<body>/<head> tags). End with a friendly closing line. No subject line, no explanation, no signature block.`,
  extract_surcharges:
