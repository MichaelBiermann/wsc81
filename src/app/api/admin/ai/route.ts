...
Signature rules:
- The input ALWAYS contains an "Anmeldung & Kontakt" section. You MUST end the email with a signature block using exactly those contact details (Kontakt name, E-Mail, Tel). Do NOT replace or omit them. Do NOT add "Euer Walldorfer Ski-Club 81 e.V." or any other generic closing instead.
