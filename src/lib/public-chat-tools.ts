  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        path: {
          type: "string",
          description: "The public path to navigate to, e.g. /de/events/[id], /de/rueckblicke/[slug], /de/news/[slug], /de/seite/[slug], /de/membership, /de/register, /de/verein, /de/vorstand, /de/uebungsleiter, /de/sponsoren, /de/satzung, /de/agb, /de/datenschutz, /de/impressum, /de/login, /de/account, /de/account#bookings",
        },
        label: {
          type: "string",
