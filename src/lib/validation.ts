...
export const EventSchema = z.object({
  ...
  organisation: z.string().max(300).trim().optional().nullable(),
  organisationEmail: z.string().max(254).trim().optional().nullable(),
  organisationPhone: z.string().max(50).trim().optional().nullable(),
